package project.collectionAsTransferableObjectAndMiniDatabase.user;

import java.util.Enumeration;
import java.util.Scanner;

import project.collectionAsTransferableObjectAndMiniDatabase.beans.Employee;
import project.collectionAsTransferableObjectAndMiniDatabase.dao.Company;
import project.collectionAsTransferableObjectAndMiniDatabase.exceptions.DuplicateEmployeeExcepiton;
import project.collectionAsTransferableObjectAndMiniDatabase.exceptions.EmployeeClassNotFoundException;
import project.collectionAsTransferableObjectAndMiniDatabase.exceptions.EmployeeNotFoundException;
